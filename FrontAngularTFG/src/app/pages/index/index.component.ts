...
export class IndexComponent implements OnInit {
  ...
  private chart1: any;
  private candlestickSeries1: any;
  ...
  async loadStockData() {
    ...
    this.stockData = await this.stockService.getStockData('AAPL').toPromise()
  ...
  loadData() {
    ...
    const data = [ { time: '2018-10-19', value: 26.19 },
  ...
  createChart1() {
    ...
    this.chart1 = createChart(container, {
      width: 700,
      height: 350,
      layout: {
        background: {color: '#1e2329'},
    ...
    const series = this.chart1.addAreaSeries({
      topColor: '#2962FF',
      bottomColor: 'rgba(41, 98, 255, 0.28)',
      lineColor: '#2962FF',
      lineWidth: 2
    });
    this.candlestickSeries1 = this.chart1.addAreaSeries();
    this.loadData1();
  }
  ...
  loadData1() {
    ...
    console.log(this.stockData);
    this.candlestickSeries1.setData(this.stockData);
